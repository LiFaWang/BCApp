...
public class BatchNumAdapter extends HsBaseAdapter<TopDataBean> {
    public BatchNumAdapter(List<TopDataBean> list, Context context) {
        super(list, context);
    }
